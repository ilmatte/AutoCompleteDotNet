namespace AutoComplete.Common
{
    ...
    internal class AutoCompleteSettingsDto
    {
        ...
        /// </summary>
        internal string ValueField { get; set; }
        ...
        /// </summary>
        internal bool RegisterJQueryAndJQueryUI { get; set; }
        ...
        /// Default value is false.
        /// </summary>
        internal bool RegisterDefaultStyleSheet { get; set; }
        ...
        /// in the dropdownlist.
        /// </summary>
        internal string NoResultsMessage { get; set; }
